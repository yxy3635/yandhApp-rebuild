<template>
  <div class="loading-spinner-container">
    <div aria-label="加载中" role="img" class="wheel-and-hamster">
      <div class="wheel"></div>
      <div class="hamster">
...
/* Dark theme — subtly tone down the wheel */
body.dark-theme .wheel {
  background: radial-gradient(100% 100% at center, hsla(0, 0%, 50%, 0) 47.8%, hsl(0, 0%, 48%) 48%);
}

body.dark-theme .spoke {
